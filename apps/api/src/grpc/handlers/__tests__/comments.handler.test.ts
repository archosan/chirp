...
import { notFound, validationFailed } from "../../../error";
...
describe("CommentsHandler", () => {
  ...
  describe("createComment", () => {
    ...
    it("returns error when post not found", async () => {
      ...
      vi.mocked(createComment).mockRejectedValue(notFound("Post not found"));
  ...
  describe("deleteComment", () => {
    ...
    it("returns error when user is not the author", async () => {
      ...
      vi.mocked(deleteComment).mockRejectedValue(
        validationFailed("You can only delete your own comments"),
      );
      ...
      expect(result.success).toBe(false);
      expect(result.error).toContain("You can only delete your own comments");
    });
  });
});
